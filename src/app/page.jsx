    ...
    <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center"> 
        ...
        <div className="flex gap-4 w-full mb-4">
          <Link href="/Rishabh-resume.pdf" target= "_blank" alt="my-cv" rel="noopener noreferrer"><button className="p-2 rounded-md ring-1 ring-black bg-black text-white">My Resume</button></Link>
          <Link href="/contact"><button className="p-2 rounded-md ring-1 ring-black ">Contact Me</button></Link>
        </div>
      </div>
    </div>  
